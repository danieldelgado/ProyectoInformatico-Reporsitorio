...
/**
 * Provides the local service interface for avanceEstadoSolicitudReclutamiento. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see avanceEstadoSolicitudReclutamientoLocalServiceUtil
...
public interface avanceEstadoSolicitudReclutamientoLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link avanceEstadoSolicitudReclutamientoLocalServiceUtil} to access the avance estado solicitud reclutamiento local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.avanceEstadoSolicitudReclutamientoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
