...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.rec.hitss.layer.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.rec.hitss.layer.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.rec.hitss.layer.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.rec.hitss.layer.model.Foo toUnescapedModel() {
