...
/**
 * Provides the local service interface for EvaluacionReclutamiento. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see EvaluacionReclutamientoLocalServiceUtil
...
public interface EvaluacionReclutamientoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EvaluacionReclutamientoLocalServiceUtil} to access the evaluacion reclutamiento local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.EvaluacionReclutamientoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
