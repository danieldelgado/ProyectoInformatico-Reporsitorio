...
import com.rec.hitss.layer.NoSuchContratoException;
import com.rec.hitss.layer.model.Contrato;
import com.rec.hitss.layer.model.impl.ContratoImpl;
import com.rec.hitss.layer.model.impl.ContratoModelImpl;
...
public class ContratoPersistenceImpl extends BasePersistenceImpl<Contrato>
	 ...
	 */
	@Override
	public Contrato create(long CT_ID) {
		Contrato contrato = new ContratoImpl();

		contrato.setNew(true);
		contrato.setPrimaryKey(CT_ID);
	 ...
	 */
	@Override
	public Contrato remove(long CT_ID)
		throws NoSuchContratoException, SystemException {
		return remove((Serializable)CT_ID);
	}
	...
	@Override
	public Contrato updateImpl(com.rec.hitss.layer.model.Contrato contrato)
	...
	protected Contrato toUnwrappedModel(Contrato contrato) {
		...
		contratoImpl.setCT_ID(contrato.getCT_ID());
		contratoImpl.setCT_ESTADO(contrato.getCT_ESTADO());
		contratoImpl.setCT_ACTIVO(contrato.getCT_ACTIVO());
		contratoImpl.setCT_USUARIO_CREA(contrato.getCT_USUARIO_CREA());
		contratoImpl.setCT_FECHA_CREA(contrato.getCT_FECHA_CREA());
		contratoImpl.setCT_USUARIO_MODIFICA(contrato.getCT_USUARIO_MODIFICA());
		contratoImpl.setCT_FECHA_MODIFICA(contrato.getCT_FECHA_MODIFICA());
	 ...
	 */
	@Override
	public Contrato findByPrimaryKey(long CT_ID)
		throws NoSuchContratoException, SystemException {
		return findByPrimaryKey((Serializable)CT_ID);
	}
	 ...
	 */
	@Override
	public Contrato fetchByPrimaryKey(long CT_ID) throws SystemException {
		return fetchByPrimaryKey((Serializable)CT_ID);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.Contrato")));
