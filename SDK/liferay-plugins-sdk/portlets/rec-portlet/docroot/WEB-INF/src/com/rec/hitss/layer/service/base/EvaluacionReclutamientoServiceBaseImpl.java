...
import com.rec.hitss.layer.service.EvaluacionReclutamientoService;
...
/**
 * Provides the base implementation for the evaluacion reclutamiento remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rec.hitss.layer.service.impl.EvaluacionReclutamientoServiceImpl}.
 * </p>
 *
 * @author Crossfire
 ...
 * @generated
 */
public abstract class EvaluacionReclutamientoServiceBaseImpl
	extends BaseServiceImpl implements EvaluacionReclutamientoService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rec.hitss.layer.service.EvaluacionReclutamientoServiceUtil} to access the evaluacion reclutamiento remote service.
	 */
	...
	private EvaluacionReclutamientoServiceClpInvoker _clpInvoker = new EvaluacionReclutamientoServiceClpInvoker();
}