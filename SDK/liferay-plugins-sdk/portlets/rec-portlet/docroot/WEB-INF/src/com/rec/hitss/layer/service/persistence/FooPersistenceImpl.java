...
import com.rec.hitss.layer.NoSuchFooException;
import com.rec.hitss.layer.model.Foo;
import com.rec.hitss.layer.model.impl.FooImpl;
import com.rec.hitss.layer.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.rec.hitss.layer.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.Foo")));
