...
import com.rec.hitss.layer.service.solicitudReclutamientoService;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the solicitud reclutamiento remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rec.hitss.layer.service.impl.solicitudReclutamientoServiceImpl}.
 * </p>
 *
 * @author Crossfire
 ...
 * @generated
 */
public abstract class solicitudReclutamientoServiceBaseImpl
	extends BaseServiceImpl implements solicitudReclutamientoService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rec.hitss.layer.service.solicitudReclutamientoServiceUtil} to access the solicitud reclutamiento remote service.
	 */
	...
	private solicitudReclutamientoServiceClpInvoker _clpInvoker = new solicitudReclutamientoServiceClpInvoker();
}