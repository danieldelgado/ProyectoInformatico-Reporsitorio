...
import com.rec.hitss.layer.service.cartillaReclutamientoService;
...
/**
 * Provides the base implementation for the cartilla reclutamiento remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rec.hitss.layer.service.impl.cartillaReclutamientoServiceImpl}.
 * </p>
 *
 * @author Crossfire
 ...
 * @generated
 */
public abstract class cartillaReclutamientoServiceBaseImpl
	extends BaseServiceImpl implements cartillaReclutamientoService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rec.hitss.layer.service.cartillaReclutamientoServiceUtil} to access the cartilla reclutamiento remote service.
	 */
	...
	private cartillaReclutamientoServiceClpInvoker _clpInvoker = new cartillaReclutamientoServiceClpInvoker();
}