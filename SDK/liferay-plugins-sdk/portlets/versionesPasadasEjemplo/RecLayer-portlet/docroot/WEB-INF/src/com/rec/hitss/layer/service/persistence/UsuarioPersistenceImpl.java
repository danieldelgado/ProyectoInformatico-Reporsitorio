...
import com.rec.hitss.layer.NoSuchUsuarioException;
import com.rec.hitss.layer.model.Usuario;
import com.rec.hitss.layer.model.impl.UsuarioImpl;
import com.rec.hitss.layer.model.impl.UsuarioModelImpl;
...
public class UsuarioPersistenceImpl extends BasePersistenceImpl<Usuario>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN =
		new FinderPath(UsuarioModelImpl.ENTITY_CACHE_ENABLED,
			UsuarioModelImpl.FINDER_CACHE_ENABLED, UsuarioImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByResponsableAsingadoSolReclutamientoIn",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN =
		new FinderPath(UsuarioModelImpl.ENTITY_CACHE_ENABLED,
			UsuarioModelImpl.FINDER_CACHE_ENABLED, UsuarioImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN =
		new FinderPath(UsuarioModelImpl.ENTITY_CACHE_ENABLED,
			UsuarioModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByResponsableAsingadoSolReclutamientoIn",
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN =
		new FinderPath(UsuarioModelImpl.ENTITY_CACHE_ENABLED,
			UsuarioModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByResponsableAsingadoSolReclutamientoIn",
	 ...
	 */
	@Override
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		long userId) throws SystemException {
		return findByResponsableAsingadoSolReclutamientoIn(userId,
	...
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		...
		return findByResponsableAsingadoSolReclutamientoIn(userId, start, end,
			null);
	}
	...
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN;
			finderArgs = new Object[] { userId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN_USERID_2);
	 ...
	 * @throws com.rec.hitss.layer.NoSuchUsuarioException if a matching usuario could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public Usuario findByResponsableAsingadoSolReclutamientoIn_First(
		long userId, OrderByComparator orderByComparator)
		throws NoSuchUsuarioException, SystemException {
		Usuario usuario = fetchByResponsableAsingadoSolReclutamientoIn_First(userId,
				orderByComparator);
	 ...
	 */
	@Override
	public Usuario fetchByResponsableAsingadoSolReclutamientoIn_First(
		long userId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Usuario> list = findByResponsableAsingadoSolReclutamientoIn(userId,
	 ...
	 */
	@Override
	public Usuario findByResponsableAsingadoSolReclutamientoIn_Last(
		long userId, OrderByComparator orderByComparator)
		throws NoSuchUsuarioException, SystemException {
		Usuario usuario = fetchByResponsableAsingadoSolReclutamientoIn_Last(userId,
				orderByComparator);
	 ...
	 */
	@Override
	public Usuario fetchByResponsableAsingadoSolReclutamientoIn_Last(
		long userId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByResponsableAsingadoSolReclutamientoIn(userId);
	...
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		...
		return findByResponsableAsingadoSolReclutamientoIn(userIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		...
		return findByResponsableAsingadoSolReclutamientoIn(userIds, start, end,
			null);
	}
	...
	public List<Usuario> findByResponsableAsingadoSolReclutamientoIn(
		...
		if ((userIds != null) && (userIds.length == 1)) {
			return findByResponsableAsingadoSolReclutamientoIn(userIds[0],
		...
		List<Usuario> list = (List<Usuario>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
				finderArgs, this);
		...
		if (list == null) {
			...
			if ((userIds == null) || (userIds.length > 0)) {
				...
				for (int i = 0; i < userIds.length; i++) {
					query.append(_FINDER_COLUMN_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN_USERID_5);
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					finderArgs);
	 ...
	 */
	@Override
	public void removeByResponsableAsingadoSolReclutamientoIn(long userId)
		throws SystemException {
		for (Usuario usuario : findByResponsableAsingadoSolReclutamientoIn(
	 ...
	 */
	@Override
	public int countByResponsableAsingadoSolReclutamientoIn(long userId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN;
	 ...
	 */
	@Override
	public int countByResponsableAsingadoSolReclutamientoIn(long[] userIds)
		throws SystemException {
		Object[] finderArgs = new Object[] { StringUtil.merge(userIds) };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN_USERID_2 =
		"usuario.userId = ? AND usuario.activo=true";
	private static final String _FINDER_COLUMN_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN_USERID_5 =
		"(" +
		removeConjunction(_FINDER_COLUMN_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN_USERID_2) +
		")";
	 ...
	 * @throws com.rec.hitss.layer.NoSuchUsuarioException if a usuario with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	@Override
	public Usuario updateImpl(com.rec.hitss.layer.model.Usuario usuario)
		throws SystemException {
		usuario = toUnwrappedModel(usuario);
		...
		if (isNew || !UsuarioModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((usuarioModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						usuarioModelImpl.getOriginalUserId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_RESPONSABLEASINGADOSOLRECLUTAMIENTOIN,
					args);
	...
	protected Usuario toUnwrappedModel(Usuario usuario) {
		...
		usuarioImpl.setUsuarioLider(usuario.getUsuarioLider());
		usuarioImpl.setLider(usuario.isLider());
	...
	/**
	 * Returns the usuario with the primary key or throws a {@link com.rec.hitss.layer.NoSuchUsuarioException} if it could not be found.
	 *
	 * @param userId the primary key of the usuario
	 * @return the usuario
	 * @throws com.rec.hitss.layer.NoSuchUsuarioException if a usuario with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.Usuario")));
