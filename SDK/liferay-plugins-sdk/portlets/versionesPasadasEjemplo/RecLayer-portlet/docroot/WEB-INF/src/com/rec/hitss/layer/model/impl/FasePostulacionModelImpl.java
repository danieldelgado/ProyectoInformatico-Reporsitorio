...
import com.rec.hitss.layer.model.FasePostulacionModel;
import com.rec.hitss.layer.model.FasePostulacionSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.rec.hitss.layer.model.FasePostulacionModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FasePostulacionImpl}.
 * </p>
 *
 * @author Crossfire
 * @see FasePostulacionImpl
 * @see com.rec.hitss.layer.model.FasePostulacion
 * @see com.rec.hitss.layer.model.FasePostulacionModel
 * @generated
 */
@JSON(strict = true)
public class FasePostulacionModelImpl extends BaseModelImpl<FasePostulacion>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a fase postulacion model instance should use the {@link com.rec.hitss.layer.model.FasePostulacion} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table FasePostulacion (fasePostulacionId LONG not null primary key,solicitudRequerimientoId LONG,usuarioId LONG,fechaFase DATE null,tipoFase LONG,descripcion VARCHAR(75) null,estado LONG,activo BOOLEAN,usuariocrea LONG,fechacrea DATE null,usuariomodifica LONG,fechacreamodifica DATE null)";
	public static final String TABLE_SQL_DROP = "drop table FasePostulacion";
	public static final String ORDER_BY_JPQL = " ORDER BY fasePostulacion.fechacreamodifica ASC";
	public static final String ORDER_BY_SQL = " ORDER BY FasePostulacion.fechacreamodifica ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.rec.hitss.layer.model.FasePostulacion"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.rec.hitss.layer.model.FasePostulacion"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.rec.hitss.layer.model.FasePostulacion"));
	...
	public Object clone() {
		...
		fasePostulacionImpl.setFechacreamodifica(getFechacreamodifica());
	...
	public CacheModel<FasePostulacion> toCacheModel() {
		...
		if (fechacreamodifica != null) {
			fasePostulacionCacheModel.fechacreamodifica = fechacreamodifica.getTime();
		}
		else {
			fasePostulacionCacheModel.fechacreamodifica = Long.MIN_VALUE;
		}
