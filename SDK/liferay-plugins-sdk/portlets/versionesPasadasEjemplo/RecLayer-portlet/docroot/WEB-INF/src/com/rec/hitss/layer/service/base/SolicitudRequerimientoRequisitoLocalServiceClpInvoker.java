...
public class SolicitudRequerimientoRequisitoLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return SolicitudRequerimientoRequisitoLocalServiceUtil.addSolicitudRequerimientoRequisito((com.rec.hitss.layer.model.SolicitudRequerimientoRequisito)arguments[0]);
		}

		if (_methodName1.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
			return SolicitudRequerimientoRequisitoLocalServiceUtil.createSolicitudRequerimientoRequisito((com.rec.hitss.layer.service.persistence.SolicitudRequerimientoRequisitoPK)arguments[0]);
		}

		if (_methodName2.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
			return SolicitudRequerimientoRequisitoLocalServiceUtil.deleteSolicitudRequerimientoRequisito((com.rec.hitss.layer.service.persistence.SolicitudRequerimientoRequisitoPK)arguments[0]);
		}

		if (_methodName3.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
			return SolicitudRequerimientoRequisitoLocalServiceUtil.deleteSolicitudRequerimientoRequisito((com.rec.hitss.layer.model.SolicitudRequerimientoRequisito)arguments[0]);
		}
		...
		if (_methodName10.equals(name) &&
			...
			return SolicitudRequerimientoRequisitoLocalServiceUtil.fetchSolicitudRequerimientoRequisito((com.rec.hitss.layer.service.persistence.SolicitudRequerimientoRequisitoPK)arguments[0]);
		}

		if (_methodName11.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
			return SolicitudRequerimientoRequisitoLocalServiceUtil.getSolicitudRequerimientoRequisito((com.rec.hitss.layer.service.persistence.SolicitudRequerimientoRequisitoPK)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return SolicitudRequerimientoRequisitoLocalServiceUtil.updateSolicitudRequerimientoRequisito((com.rec.hitss.layer.model.SolicitudRequerimientoRequisito)arguments[0]);
		}
