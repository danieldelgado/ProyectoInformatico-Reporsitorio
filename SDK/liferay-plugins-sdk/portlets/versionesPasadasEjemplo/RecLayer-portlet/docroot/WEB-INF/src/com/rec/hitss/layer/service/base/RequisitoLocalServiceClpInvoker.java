...
public class RequisitoLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return RequisitoLocalServiceUtil.addRequisito((com.rec.hitss.layer.model.Requisito)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return RequisitoLocalServiceUtil.deleteRequisito((com.rec.hitss.layer.model.Requisito)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return RequisitoLocalServiceUtil.updateRequisito((com.rec.hitss.layer.model.Requisito)arguments[0]);
		}
