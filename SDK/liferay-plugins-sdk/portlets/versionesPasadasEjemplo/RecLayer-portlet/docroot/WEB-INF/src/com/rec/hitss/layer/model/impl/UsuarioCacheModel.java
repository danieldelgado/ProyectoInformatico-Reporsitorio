...
public class UsuarioCacheModel implements CacheModel<Usuario>, Externalizable {
	...
	public Usuario toEntityModel() {
		...
		usuarioImpl.setUsuarioLider(usuarioLider);
		usuarioImpl.setLider(lider);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		usuarioLider = objectInput.readLong();
		lider = objectInput.readBoolean();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(usuarioLider);
		objectOutput.writeBoolean(lider);
