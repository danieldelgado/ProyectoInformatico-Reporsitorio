...
function inicializarFormularioRegistro() {
	...
	$(btnGuardar).click(function() {
		...
		if( listaFuncionMap.length == 0 ){
			mostrarAlerta(contenedorAlerta2, "Funci贸n", "Ingrese al menos una funci贸n", "alert-error", null);
			listasCorrectas = false;
		} else {
...
function agregarRequisitos() {
	...
	var contenedorAlerta2 = $(".contenedorAlerta2");
	if( annos == '' ){
		mostrarAlerta(contenedorAlerta2, "A帽os", "Seleccione el n煤mero de a帽os", "alert-error", null);
		listasCorrectas = false;
	} else {
		$(".contenedorAlerta2").empty();
		listasCorrectas = true;
...
function agregarFuncion() {
	...
	var contenedorAlerta = $(".contenedorAlerta");
	if( funcion == '' ){
		mostrarAlerta(contenedorAlerta, "Funci贸n", "Ingrese el nombre de la funci贸n ", "alert-error", null);
		listasCorrectas = false;
	} else {
		$(".contenedorAlerta").empty();
		listasCorrectas = true;
...
//	console.log(listaFuncionMap.length);
	...
	if( listaFuncionMap.length == 0 ){
		mostrarAlerta(contenedorAlerta, "Funci贸n", "Ingrese al menos una funci贸n", "alert-error", null);
		listasCorrectas = false;
		modalconfirmacion.hide();
	}
