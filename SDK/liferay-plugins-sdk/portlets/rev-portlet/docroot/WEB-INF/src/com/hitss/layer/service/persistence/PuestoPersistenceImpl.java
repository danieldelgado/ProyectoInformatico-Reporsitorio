...
import com.hitss.layer.NoSuchPuestoException;
import com.hitss.layer.model.Puesto;
import com.hitss.layer.model.impl.PuestoImpl;
import com.hitss.layer.model.impl.PuestoModelImpl;
...
public class PuestoPersistenceImpl extends BasePersistenceImpl<Puesto>
	...
	@Override
	public Puesto updateImpl(com.hitss.layer.model.Puesto puesto)
		throws SystemException {
		puesto = toUnwrappedModel(puesto);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.hitss.layer.model.Puesto")));
