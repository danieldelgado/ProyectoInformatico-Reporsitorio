...
public class ProgramaEntrevistaController extends RevController {
	...
	public String irprogramarEntrevista(RenderRequest request, RenderResponse response, Model model) {
		...
		try {
			...
			if (fasePsicologia != null && faseTecnica != null) {
				colaborador = false;
			}
	...
	public void guardarProgramacionEntrevista(ResourceRequest resourceRequest, ResourceResponse resourceResponse) {
		...
		Boolean addEvaluaciones = ParamUtil.getBoolean(resourceRequest, "addEvaluaciones");

		Map<String, Object> result = programaEntrevistaService.guardarProgramacionEntevista(solicitudId, userId, user, addEvaluaciones, fasePsicologia, faseTecnica,
				faseEntreCoordRRHH, faseEntreGerenteArea);
