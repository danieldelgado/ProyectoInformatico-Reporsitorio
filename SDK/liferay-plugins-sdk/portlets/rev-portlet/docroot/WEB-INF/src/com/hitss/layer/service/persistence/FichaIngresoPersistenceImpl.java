...
import com.hitss.layer.NoSuchFichaIngresoException;
import com.hitss.layer.model.FichaIngreso;
import com.hitss.layer.model.impl.FichaIngresoImpl;
import com.hitss.layer.model.impl.FichaIngresoModelImpl;
...
public class FichaIngresoPersistenceImpl extends BasePersistenceImpl<FichaIngreso>
	 ...
	 */
	@Override
	public FichaIngreso create(FichaIngresoPK fichaIngresoPK) {
		FichaIngreso fichaIngreso = new FichaIngresoImpl();

		fichaIngreso.setNew(true);
		fichaIngreso.setPrimaryKey(fichaIngresoPK);
	 ...
	 */
	@Override
	public FichaIngreso remove(FichaIngresoPK fichaIngresoPK)
		throws NoSuchFichaIngresoException, SystemException {
		return remove((Serializable)fichaIngresoPK);
	}
	...
	protected FichaIngreso toUnwrappedModel(FichaIngreso fichaIngreso) {
		...
		fichaIngresoImpl.setActivo(fichaIngreso.isActivo());
		fichaIngresoImpl.setUsuariocrea(fichaIngreso.getUsuariocrea());
		fichaIngresoImpl.setFechacrea(fichaIngreso.getFechacrea());
		fichaIngresoImpl.setUsuariomodifica(fichaIngreso.getUsuariomodifica());
		fichaIngresoImpl.setFechamodifica(fichaIngreso.getFechamodifica());
	 ...
	 */
	@Override
	public FichaIngreso findByPrimaryKey(FichaIngresoPK fichaIngresoPK)
		throws NoSuchFichaIngresoException, SystemException {
		return findByPrimaryKey((Serializable)fichaIngresoPK);
	}
	 ...
	 */
	@Override
	public FichaIngreso fetchByPrimaryKey(FichaIngresoPK fichaIngresoPK)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)fichaIngresoPK);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.hitss.layer.model.FichaIngreso")));
