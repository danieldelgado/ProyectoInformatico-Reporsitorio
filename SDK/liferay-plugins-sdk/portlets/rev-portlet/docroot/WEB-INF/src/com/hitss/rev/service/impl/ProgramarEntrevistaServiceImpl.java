...
//							fase = FasePostulacionLocalServiceUtil.getLastPostulacion(post.getSolicitudRequerimientoId(), usuario.getUserId());							
	...
	@Override
	public FasePostulacionBean getFaseEntreCoodRRHH(Long solicitudId,
			Long userId) {
		return getFasePostualcion(solicitudId,userId,Constantes.PARAMETRO_FASE_ENTREV_COORDINADOR);
	}

	@Override
	public FasePostulacionBean getFaseEntreGerenteArea(Long solicitudId,
			Long userId) {
		return getFasePostualcion(solicitudId,userId,Constantes.PARAMETRO_FASE_ENTREV_GERENTE_AREA);
	}

	private FasePostulacionBean getFasePostualcion(Long solicitudId,
			Long userId, long parametroFase) {
	...
	@Override
	public Map<String, Object> guardarProgramacionEntevista(Long solicitudId,
