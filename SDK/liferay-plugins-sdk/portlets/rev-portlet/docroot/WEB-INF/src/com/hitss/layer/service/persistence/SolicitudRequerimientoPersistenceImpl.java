...
public class SolicitudRequerimientoPersistenceImpl extends BasePersistenceImpl<SolicitudRequerimiento>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A = new FinderPath(SolicitudRequerimientoModelImpl.ENTITY_CACHE_ENABLED,
			SolicitudRequerimientoModelImpl.FINDER_CACHE_ENABLED,
			SolicitudRequerimientoImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A = new FinderPath(SolicitudRequerimientoModelImpl.ENTITY_CACHE_ENABLED,
			SolicitudRequerimientoModelImpl.FINDER_CACHE_ENABLED,
			SolicitudRequerimientoImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA",
			new String[] { Boolean.class.getName() },
			SolicitudRequerimientoModelImpl.ACTIVO_COLUMN_BITMASK |
			SolicitudRequerimientoModelImpl.FECHAMODIFICA_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_A = new FinderPath(SolicitudRequerimientoModelImpl.ENTITY_CACHE_ENABLED,
			SolicitudRequerimientoModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<SolicitudRequerimiento> findByA(boolean activo)
		throws SystemException {
		return findByA(activo, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<SolicitudRequerimiento> findByA(boolean activo, int start,
		int end) throws SystemException {
		return findByA(activo, start, end, null);
	}
	...
	public List<SolicitudRequerimiento> findByA(boolean activo, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SolicitudRequerimiento solicitudRequerimiento : list) {
				if ((activo != solicitudRequerimiento.getActivo())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_A_ACTIVO_2);
	 ...
	 */
	@Override
	public SolicitudRequerimiento findByA_First(boolean activo,
		OrderByComparator orderByComparator)
		throws NoSuchSolicitudRequerimientoException, SystemException {
		SolicitudRequerimiento solicitudRequerimiento = fetchByA_First(activo,
				orderByComparator);
	 ...
	 */
	@Override
	public SolicitudRequerimiento fetchByA_First(boolean activo,
		OrderByComparator orderByComparator) throws SystemException {
		List<SolicitudRequerimiento> list = findByA(activo, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public SolicitudRequerimiento findByA_Last(boolean activo,
		OrderByComparator orderByComparator)
		throws NoSuchSolicitudRequerimientoException, SystemException {
		SolicitudRequerimiento solicitudRequerimiento = fetchByA_Last(activo,
				orderByComparator);
	 ...
	 */
	@Override
	public SolicitudRequerimiento fetchByA_Last(boolean activo,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByA(activo);

		if (count == 0) {
			return null;
		}

		List<SolicitudRequerimiento> list = findByA(activo, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public SolicitudRequerimiento[] findByA_PrevAndNext(
		...
		try {
			...
			array[0] = getByA_PrevAndNext(session, solicitudRequerimiento,
					activo, orderByComparator, true);

			array[1] = solicitudRequerimiento;

			array[2] = getByA_PrevAndNext(session, solicitudRequerimiento,
					activo, orderByComparator, false);
	...
	protected SolicitudRequerimiento getByA_PrevAndNext(Session session,
		SolicitudRequerimiento solicitudRequerimiento, boolean activo,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByA(boolean activo) throws SystemException {
		for (SolicitudRequerimiento solicitudRequerimiento : findByA(activo,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(solicitudRequerimiento);
		}
	}
	 ...
	 */
	@Override
	public int countByA(boolean activo) throws SystemException {
	...
	private static final String _FINDER_COLUMN_A_ACTIVO_2 = "solicitudRequerimiento.activo = ?";
	...
	public SolicitudRequerimiento updateImpl(
		...
		if (isNew || !SolicitudRequerimientoModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((solicitudRequerimientoModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						solicitudRequerimientoModelImpl.getOriginalActivo()
					};
				...
				args = new Object[] { solicitudRequerimientoModelImpl.getActivo() };
