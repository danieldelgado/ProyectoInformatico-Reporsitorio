...
public class ExperienciaBean {
	...
	public ExperienciaBean(long id, String empresa, long tipoNegocioProyecto, String proyecto, Date fechaInicio, Date fechaFin) {
		super();
		this.id = id;
	...
	public double getAnnos() {
		if (annos == 0) {
			...
			double diff = (double) (new Double(b.get(Calendar.YEAR)) - new Double(a.get(Calendar.YEAR))) + (new Double(b.get(Calendar.MONTH) / 12.0));
			annos = diff;
		}
		// System.out.println("inter getAnnos:"+annos
		// +" | id:"+id+" | fechaInicio:"+fechaInicio+" | fechaFin:"+fechaFin);
		return annos;
	}
