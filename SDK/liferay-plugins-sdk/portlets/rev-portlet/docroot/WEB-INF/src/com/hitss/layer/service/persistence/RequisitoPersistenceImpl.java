...
import com.hitss.layer.NoSuchRequisitoException;
import com.hitss.layer.model.Requisito;
import com.hitss.layer.model.impl.RequisitoImpl;
import com.hitss.layer.model.impl.RequisitoModelImpl;
...
public class RequisitoPersistenceImpl extends BasePersistenceImpl<Requisito>
	 ...
	 */
	@Override
	public Requisito create(long requisitoId) {
		Requisito requisito = new RequisitoImpl();

		requisito.setNew(true);
		requisito.setPrimaryKey(requisitoId);
	 ...
	 */
	@Override
	public Requisito remove(long requisitoId)
		throws NoSuchRequisitoException, SystemException {
	...
	@Override
	public Requisito updateImpl(com.hitss.layer.model.Requisito requisito)
		throws SystemException {
		requisito = toUnwrappedModel(requisito);
	...
	protected Requisito toUnwrappedModel(Requisito requisito) {
		...
		requisitoImpl.setRequisitoId(requisito.getRequisitoId());
	 ...
	 */
	@Override
	public Requisito findByPrimaryKey(long requisitoId)
		throws NoSuchRequisitoException, SystemException {
	 ...
	 */
	@Override
	public Requisito fetchByPrimaryKey(long requisitoId)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.hitss.layer.model.Requisito")));
