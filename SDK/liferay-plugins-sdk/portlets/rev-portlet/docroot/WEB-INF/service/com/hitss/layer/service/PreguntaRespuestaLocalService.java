...
/**
 * Provides the local service interface for PreguntaRespuesta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Danielle Delgado
 * @see PreguntaRespuestaLocalServiceUtil
...
public interface PreguntaRespuestaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PreguntaRespuestaLocalServiceUtil} to access the pregunta respuesta local service. Add custom service methods to {@link com.hitss.layer.service.impl.PreguntaRespuestaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
