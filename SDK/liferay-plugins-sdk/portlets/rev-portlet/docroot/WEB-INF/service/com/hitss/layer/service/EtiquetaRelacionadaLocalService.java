...
/**
 * Provides the local service interface for EtiquetaRelacionada. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Danielle Delgado
 * @see EtiquetaRelacionadaLocalServiceUtil
 * @see com.hitss.layer.service.base.EtiquetaRelacionadaLocalServiceBaseImpl
 * @see com.hitss.layer.service.impl.EtiquetaRelacionadaLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface EtiquetaRelacionadaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EtiquetaRelacionadaLocalServiceUtil} to access the etiqueta relacionada local service. Add custom service methods to {@link com.hitss.layer.service.impl.EtiquetaRelacionadaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
