...
/**
 * The persistence utility for the usuario funcion service. This utility wraps {@link UsuarioFuncionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class UsuarioFuncionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(UsuarioFuncion usuarioFuncion) {
		getPersistence().clearCache(usuarioFuncion);
	}
	 ...
	 */
	public static List<UsuarioFuncion> findWithDynamicQuery(
	 ...
	 */
	public static UsuarioFuncion update(UsuarioFuncion usuarioFuncion)
		throws SystemException {
		return getPersistence().update(usuarioFuncion);
	}
	...
	public static UsuarioFuncion update(UsuarioFuncion usuarioFuncion,
		...
		return getPersistence().update(usuarioFuncion, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(usuarioFuncion);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(usuarioFuncions);
	}
	...
	*/
	public static com.hitss.layer.model.UsuarioFuncion create(
		com.hitss.layer.service.persistence.UsuarioFuncionPK usuarioFuncionPK) {
		return getPersistence().create(usuarioFuncionPK);
	}
	...
	*/
	public static com.hitss.layer.model.UsuarioFuncion remove(
		com.hitss.layer.service.persistence.UsuarioFuncionPK usuarioFuncionPK)
		throws com.hitss.layer.NoSuchUsuarioFuncionException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(usuarioFuncionPK);
	}

	public static com.hitss.layer.model.UsuarioFuncion updateImpl(
		com.hitss.layer.model.UsuarioFuncion usuarioFuncion)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(usuarioFuncion);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.hitss.layer.model.UsuarioFuncion findByPrimaryKey(
		com.hitss.layer.service.persistence.UsuarioFuncionPK usuarioFuncionPK)
		throws com.hitss.layer.NoSuchUsuarioFuncionException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(usuarioFuncionPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.hitss.layer.model.UsuarioFuncion fetchByPrimaryKey(
		com.hitss.layer.service.persistence.UsuarioFuncionPK usuarioFuncionPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(usuarioFuncionPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.hitss.layer.model.UsuarioFuncion> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static UsuarioFuncionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (UsuarioFuncionPersistence)PortletBeanLocatorUtil.locate(com.hitss.layer.service.ClpSerializer.getServletContextName(),
					UsuarioFuncionPersistence.class.getName());

			ReferenceRegistry.registerReference(UsuarioFuncionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(UsuarioFuncionPersistence persistence) {
	}

	private static UsuarioFuncionPersistence _persistence;
}