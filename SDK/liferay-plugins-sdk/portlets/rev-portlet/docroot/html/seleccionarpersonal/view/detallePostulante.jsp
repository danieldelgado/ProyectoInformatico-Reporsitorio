...
<fieldset>
	<legend>Postulante ${usuarioPostulante.fullname}</legend>
	<div class="container">
		<div class="offset1 span10">
			<form id="<portlet:namespace/>seleccionarPostulante" class="formulario">
				<input id="<portlet:namespace/>solicitudId" name="<portlet:namespace/>userId" type="hidden" value="${usuarioPostulante.solicitudId}" /> <input
					id="<portlet:namespace/>userId" name="<portlet:namespace/>userId" type="hidden" value="${usuarioPostulante.userId}" />
				...
				<div class="row">
					...
					<div class="span12">
						<fieldset>
							...
							</label> <label> Distancia de Euclidiana de las entrevistas : <fmt:formatNumber pattern="0.00" value="${usuarioPostulante.distanciaEuclidianaEntrevista*100}" />%
