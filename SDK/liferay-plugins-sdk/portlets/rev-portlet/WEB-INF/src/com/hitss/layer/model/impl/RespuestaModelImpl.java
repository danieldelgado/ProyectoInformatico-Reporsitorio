...
public class RespuestaModelImpl extends BaseModelImpl<Respuesta>
	...
	public static final String TABLE_SQL_CREATE = "create table Respuesta (respuestaId LONG not null primary key,descripcion VARCHAR(75) null,correcta BOOLEAN,activo BOOLEAN,usuariocrea LONG,fechacrea DATE null,usuariomodifica LONG,fechacreamodifica DATE null)";
	public static final String TABLE_SQL_DROP = "drop table Respuesta";
	public static final String ORDER_BY_JPQL = " ORDER BY respuesta.fechacreamodifica ASC";
	public static final String ORDER_BY_SQL = " ORDER BY Respuesta.fechacreamodifica ASC";
	...
	public Object clone() {
		...
		respuestaImpl.setFechacreamodifica(getFechacreamodifica());
	...
	public CacheModel<Respuesta> toCacheModel() {
		...
		if (fechacreamodifica != null) {
			respuestaCacheModel.fechacreamodifica = fechacreamodifica.getTime();
		}
		else {
			respuestaCacheModel.fechacreamodifica = Long.MIN_VALUE;
		}
