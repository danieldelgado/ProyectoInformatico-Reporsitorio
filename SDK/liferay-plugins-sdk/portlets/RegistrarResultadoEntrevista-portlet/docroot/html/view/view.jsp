...
<aui:fieldset label="Lista solicitudes">
		...
		<aui:col span="12">
			...
			<liferay-ui:search-container id="listaRequerimientoSolicitud"
				...
				<liferay-ui:search-container-row
					className="com.hitss.rec.registrarResultadoEntrevista.bean.SolicitudRequerimientoBean"
					modelVar="solreq">
					...
					<liferay-ui:search-container-column-text href="${listaPostulantes}"
						name="Opciones" value="Listar Entrevistados" />
