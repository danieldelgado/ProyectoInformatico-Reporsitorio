...
/**
 * Provides the local service interface for SolicitudEvaluacionDesempeno. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see SolicitudEvaluacionDesempenoLocalServiceUtil
...
public interface SolicitudEvaluacionDesempenoLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SolicitudEvaluacionDesempenoLocalServiceUtil} to access the solicitud evaluacion desempeno local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.SolicitudEvaluacionDesempenoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
