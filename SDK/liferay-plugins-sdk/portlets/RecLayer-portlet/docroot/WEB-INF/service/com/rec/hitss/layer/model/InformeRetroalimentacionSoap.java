...
/**
 * This class is used by SOAP remote services, specifically {@link com.rec.hitss.layer.service.http.InformeRetroalimentacionServiceSoap}.
 *
 * @author Crossfire
 * @see com.rec.hitss.layer.service.http.InformeRetroalimentacionServiceSoap
 * @generated
 */
public class InformeRetroalimentacionSoap implements Serializable {
	public static InformeRetroalimentacionSoap toSoapModel(
		...
		soapModel.setFechaEmision(model.getFechaEmision());
		soapModel.setTitulo(model.getTitulo());
		soapModel.setIntegrante(model.getIntegrante());
