...
public class ActividadPlanClp extends BaseModelImpl<ActividadPlan>
	...
	public void setDuracion(int duracion) {
		...
		if (_actividadPlanRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setDuracion", int.class);

				method.invoke(_actividadPlanRemoteModel, duracion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCumplio(boolean cumplio) {
		...
		if (_actividadPlanRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setCumplio", boolean.class);

				method.invoke(_actividadPlanRemoteModel, cumplio);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setObservacion(String observacion) {
		...
		if (_actividadPlanRemoteModel != null) {
			try {
				...
				method.invoke(_actividadPlanRemoteModel, observacion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public int compareTo(ActividadPlan actividadPlan) {
		...
		value = DateUtil.compareTo(getFechacrea(), actividadPlan.getFechacrea());
	...
	public String toXmlString() {
		...
		sb.append("com.rec.hitss.layer.model.ActividadPlan");
