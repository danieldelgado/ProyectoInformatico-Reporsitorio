...
/**
 * The persistence utility for the conocimiento service. This utility wraps {@link ConocimientoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ConocimientoUtil {
	 ...
	 */
	public static void clearCache(Conocimiento conocimiento) {
		getPersistence().clearCache(conocimiento);
	}
	 ...
	 */
	public static List<Conocimiento> findWithDynamicQuery(
	 ...
	 */
	public static Conocimiento update(Conocimiento conocimiento)
		throws SystemException {
		return getPersistence().update(conocimiento);
	}
	...
	public static Conocimiento update(Conocimiento conocimiento,
		...
		return getPersistence().update(conocimiento, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(conocimiento);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(conocimientos);
	}
	...
	*/
	public static com.rec.hitss.layer.model.Conocimiento create(
		long conocimientoId) {
		return getPersistence().create(conocimientoId);
	}
	...
	*/
	public static com.rec.hitss.layer.model.Conocimiento remove(
		long conocimientoId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchConocimientoException {
		return getPersistence().remove(conocimientoId);
	}

	public static com.rec.hitss.layer.model.Conocimiento updateImpl(
		com.rec.hitss.layer.model.Conocimiento conocimiento)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(conocimiento);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.Conocimiento findByPrimaryKey(
		long conocimientoId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchConocimientoException {
		return getPersistence().findByPrimaryKey(conocimientoId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.Conocimiento fetchByPrimaryKey(
		long conocimientoId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(conocimientoId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rec.hitss.layer.model.Conocimiento> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ConocimientoPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ConocimientoPersistence)PortletBeanLocatorUtil.locate(com.rec.hitss.layer.service.ClpSerializer.getServletContextName(),
					ConocimientoPersistence.class.getName());

			ReferenceRegistry.registerReference(ConocimientoUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ConocimientoPersistence persistence) {
	}

	private static ConocimientoPersistence _persistence;
}