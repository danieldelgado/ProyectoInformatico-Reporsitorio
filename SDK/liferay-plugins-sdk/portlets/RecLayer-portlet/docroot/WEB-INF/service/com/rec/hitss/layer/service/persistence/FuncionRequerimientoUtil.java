...
/**
 * The persistence utility for the funcion requerimiento service. This utility wraps {@link FuncionRequerimientoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FuncionRequerimientoPersistenceImpl
 * @generated
 */
public class FuncionRequerimientoUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FuncionRequerimiento funcionRequerimiento) {
		getPersistence().clearCache(funcionRequerimiento);
	}
	 ...
	 */
	public static List<FuncionRequerimiento> findWithDynamicQuery(
	 ...
	 */
	public static FuncionRequerimiento update(
		FuncionRequerimiento funcionRequerimiento) throws SystemException {
		return getPersistence().update(funcionRequerimiento);
	}
	 ...
	 */
	public static FuncionRequerimiento update(
		FuncionRequerimiento funcionRequerimiento, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(funcionRequerimiento, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(funcionRequerimiento);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.rec.hitss.layer.model.FuncionRequerimiento> funcionRequerimientos) {
		getPersistence().cacheResult(funcionRequerimientos);
	}
	...
	*/
	public static com.rec.hitss.layer.model.FuncionRequerimiento create(
		long funcionId) {
	...
	*/
	public static com.rec.hitss.layer.model.FuncionRequerimiento remove(
		long funcionId)
	...
	public static com.rec.hitss.layer.model.FuncionRequerimiento updateImpl(
		com.rec.hitss.layer.model.FuncionRequerimiento funcionRequerimiento)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(funcionRequerimiento);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.FuncionRequerimiento findByPrimaryKey(
		long funcionId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchFuncionRequerimientoException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.FuncionRequerimiento fetchByPrimaryKey(
		long funcionId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rec.hitss.layer.model.FuncionRequerimiento> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FuncionRequerimientoPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FuncionRequerimientoPersistence)PortletBeanLocatorUtil.locate(com.rec.hitss.layer.service.ClpSerializer.getServletContextName(),
					FuncionRequerimientoPersistence.class.getName());

			ReferenceRegistry.registerReference(FuncionRequerimientoUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FuncionRequerimientoPersistence persistence) {
	}

	private static FuncionRequerimientoPersistence _persistence;
}