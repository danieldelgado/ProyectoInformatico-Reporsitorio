...
/**
 * The persistence utility for the actividades service. This utility wraps {@link ActividadesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ActividadesUtil {
	 ...
	 */
	public static void clearCache(Actividades actividades) {
		getPersistence().clearCache(actividades);
	}
	 ...
	 */
	public static List<Actividades> findWithDynamicQuery(
	 ...
	 */
	public static Actividades update(Actividades actividades)
		throws SystemException {
		return getPersistence().update(actividades);
	}
	...
	public static Actividades update(Actividades actividades,
		...
		return getPersistence().update(actividades, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(actividades);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(actividadeses);
	}
	...
	*/
	public static com.rec.hitss.layer.model.Actividades create(
		long actividadesId) {
		return getPersistence().create(actividadesId);
	}
	...
	*/
	public static com.rec.hitss.layer.model.Actividades remove(
		long actividadesId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchActividadesException {
		return getPersistence().remove(actividadesId);
	}

	public static com.rec.hitss.layer.model.Actividades updateImpl(
		com.rec.hitss.layer.model.Actividades actividades)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(actividades);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.Actividades findByPrimaryKey(
		long actividadesId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchActividadesException {
		return getPersistence().findByPrimaryKey(actividadesId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.Actividades fetchByPrimaryKey(
		long actividadesId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(actividadesId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rec.hitss.layer.model.Actividades> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ActividadesPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ActividadesPersistence)PortletBeanLocatorUtil.locate(com.rec.hitss.layer.service.ClpSerializer.getServletContextName(),
					ActividadesPersistence.class.getName());

			ReferenceRegistry.registerReference(ActividadesUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ActividadesPersistence persistence) {
	}

	private static ActividadesPersistence _persistence;
}