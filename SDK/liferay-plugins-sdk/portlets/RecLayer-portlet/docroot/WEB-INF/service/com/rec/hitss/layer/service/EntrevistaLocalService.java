...
/**
 * Provides the local service interface for Entrevista. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see EntrevistaLocalServiceUtil
...
public interface EntrevistaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EntrevistaLocalServiceUtil} to access the entrevista local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.EntrevistaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
