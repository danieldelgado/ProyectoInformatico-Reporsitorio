...
/**
 * The persistence utility for the resultado evaluacion service. This utility wraps {@link ResultadoEvaluacionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ResultadoEvaluacionPersistenceImpl
 * @generated
 */
public class ResultadoEvaluacionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ResultadoEvaluacion resultadoEvaluacion) {
		getPersistence().clearCache(resultadoEvaluacion);
	}
	 ...
	 */
	public static List<ResultadoEvaluacion> findWithDynamicQuery(
	 ...
	 */
	public static ResultadoEvaluacion update(
		ResultadoEvaluacion resultadoEvaluacion) throws SystemException {
		return getPersistence().update(resultadoEvaluacion);
	}
	 ...
	 */
	public static ResultadoEvaluacion update(
		ResultadoEvaluacion resultadoEvaluacion, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(resultadoEvaluacion, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(resultadoEvaluacion);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.rec.hitss.layer.model.ResultadoEvaluacion> resultadoEvaluacions) {
		getPersistence().cacheResult(resultadoEvaluacions);
	}
	...
	*/
	public static com.rec.hitss.layer.model.ResultadoEvaluacion create(
		long resultadoEvaluacionId) {
		return getPersistence().create(resultadoEvaluacionId);
	}
	...
	*/
	public static com.rec.hitss.layer.model.ResultadoEvaluacion remove(
		long resultadoEvaluacionId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchResultadoEvaluacionException {
		return getPersistence().remove(resultadoEvaluacionId);
	}

	public static com.rec.hitss.layer.model.ResultadoEvaluacion updateImpl(
		com.rec.hitss.layer.model.ResultadoEvaluacion resultadoEvaluacion)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(resultadoEvaluacion);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.ResultadoEvaluacion findByPrimaryKey(
		long resultadoEvaluacionId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rec.hitss.layer.NoSuchResultadoEvaluacionException {
		return getPersistence().findByPrimaryKey(resultadoEvaluacionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rec.hitss.layer.model.ResultadoEvaluacion fetchByPrimaryKey(
		long resultadoEvaluacionId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(resultadoEvaluacionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rec.hitss.layer.model.ResultadoEvaluacion> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ResultadoEvaluacionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ResultadoEvaluacionPersistence)PortletBeanLocatorUtil.locate(com.rec.hitss.layer.service.ClpSerializer.getServletContextName(),
					ResultadoEvaluacionPersistence.class.getName());

			ReferenceRegistry.registerReference(ResultadoEvaluacionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ResultadoEvaluacionPersistence persistence) {
	}

	private static ResultadoEvaluacionPersistence _persistence;
}