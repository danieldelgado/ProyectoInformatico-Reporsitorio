...
/**
 * Provides the local service interface for Funcion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see FuncionLocalServiceUtil
 * @see com.rec.hitss.layer.service.base.FuncionLocalServiceBaseImpl
 * @see com.rec.hitss.layer.service.impl.FuncionLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface FuncionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FuncionLocalServiceUtil} to access the funcion local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.FuncionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
