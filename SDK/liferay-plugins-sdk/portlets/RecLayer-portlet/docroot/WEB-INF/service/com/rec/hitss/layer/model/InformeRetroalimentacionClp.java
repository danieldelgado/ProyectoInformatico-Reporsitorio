...
public class InformeRetroalimentacionClp extends BaseModelImpl<InformeRetroalimentacion>
	...
	public void setResponsable(String responsable) {
		...
		if (_informeRetroalimentacionRemoteModel != null) {
			try {
				...
				method.invoke(_informeRetroalimentacionRemoteModel, responsable);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setFechaEmision(String fechaEmision) {
		...
		if (_informeRetroalimentacionRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setFechaEmision", String.class);

				method.invoke(_informeRetroalimentacionRemoteModel, fechaEmision);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIntegrante(String integrante) {
		...
		if (_informeRetroalimentacionRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIntegrante", String.class);

				method.invoke(_informeRetroalimentacionRemoteModel, integrante);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setFechaEmision(getFechaEmision());
		clone.setTitulo(getTitulo());
		clone.setIntegrante(getIntegrante());
