...
/**
 * Provides the local service interface for Evaluacion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Crossfire
 * @see EvaluacionLocalServiceUtil
 * @see com.rec.hitss.layer.service.base.EvaluacionLocalServiceBaseImpl
 * @see com.rec.hitss.layer.service.impl.EvaluacionLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface EvaluacionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EvaluacionLocalServiceUtil} to access the evaluacion local service. Add custom service methods to {@link com.rec.hitss.layer.service.impl.EvaluacionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
