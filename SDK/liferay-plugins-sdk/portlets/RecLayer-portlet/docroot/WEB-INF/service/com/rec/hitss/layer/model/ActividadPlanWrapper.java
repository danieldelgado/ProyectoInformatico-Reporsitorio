...
public class ActividadPlanWrapper implements ActividadPlan,
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Integer duracion = (Integer)attributes.get("duracion");
		...
		Boolean cumplio = (Boolean)attributes.get("cumplio");
	...
	*/
	...
	/**
	* Returns the duracion of this actividad plan.
	*
	* @return the duracion of this actividad plan
	*/
	@Override
	public int getDuracion() {
		return _actividadPlan.getDuracion();
	}

	/**
	* Sets the duracion of this actividad plan.
	*
	* @param duracion the duracion of this actividad plan
	*/
	@Override
	public void setDuracion(int duracion) {
		_actividadPlan.setDuracion(duracion);
	}
	...
	*/
	...
	/**
	* Returns the cumplio of this actividad plan.
	*
	* @return the cumplio of this actividad plan
	*/
	@Override
	public boolean getCumplio() {
		return _actividadPlan.getCumplio();
	}

	/**
	* Returns <code>true</code> if this actividad plan is cumplio.
	*
	* @return <code>true</code> if this actividad plan is cumplio; <code>false</code> otherwise
	*/
	@Override
	public boolean isCumplio() {
		return _actividadPlan.isCumplio();
	}

	/**
	* Sets whether this actividad plan is cumplio.
	*
	* @param cumplio the cumplio of this actividad plan
	*/
	@Override
	public void setCumplio(boolean cumplio) {
		_actividadPlan.setCumplio(cumplio);
	}

	/**
	* Returns the observacion of this actividad plan.
	*
	* @return the observacion of this actividad plan
	*/
	@Override
	public java.lang.String getObservacion() {
		return _actividadPlan.getObservacion();
	}

	/**
	* Sets the observacion of this actividad plan.
	*
	* @param observacion the observacion of this actividad plan
	*/
	@Override
	public void setObservacion(java.lang.String observacion) {
		_actividadPlan.setObservacion(observacion);
	}
	...
	*/
	...
	@Override
	public int compareTo(com.rec.hitss.layer.model.ActividadPlan actividadPlan) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.rec.hitss.layer.model.ActividadPlan> toCacheModel() {
		return _actividadPlan.toCacheModel();
	}

	@Override
	public com.rec.hitss.layer.model.ActividadPlan toEscapedModel() {
		return new ActividadPlanWrapper(_actividadPlan.toEscapedModel());
	}

	@Override
	public com.rec.hitss.layer.model.ActividadPlan toUnescapedModel() {
