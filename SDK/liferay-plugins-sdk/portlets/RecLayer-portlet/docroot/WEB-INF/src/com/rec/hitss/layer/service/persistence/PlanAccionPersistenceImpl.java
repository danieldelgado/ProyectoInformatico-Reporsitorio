...
import com.rec.hitss.layer.NoSuchPlanAccionException;
import com.rec.hitss.layer.model.PlanAccion;
import com.rec.hitss.layer.model.impl.PlanAccionImpl;
import com.rec.hitss.layer.model.impl.PlanAccionModelImpl;
...
public class PlanAccionPersistenceImpl extends BasePersistenceImpl<PlanAccion>
	...
	protected PlanAccion toUnwrappedModel(PlanAccion planAccion) {
		...
		planAccionImpl.setActividadesId(planAccion.getActividadesId());
		planAccionImpl.setResponsable(planAccion.getResponsable());
		planAccionImpl.setFechaEmitida(planAccion.getFechaEmitida());
		...
		planAccionImpl.setAprobadorLideres(planAccion.isAprobadorLideres());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.PlanAccion")));
