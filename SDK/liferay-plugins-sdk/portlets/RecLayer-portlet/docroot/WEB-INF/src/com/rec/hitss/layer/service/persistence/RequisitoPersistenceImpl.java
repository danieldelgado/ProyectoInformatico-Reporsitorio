...
import com.rec.hitss.layer.NoSuchRequisitoException;
import com.rec.hitss.layer.model.Requisito;
import com.rec.hitss.layer.model.impl.RequisitoImpl;
import com.rec.hitss.layer.model.impl.RequisitoModelImpl;
...
public class RequisitoPersistenceImpl extends BasePersistenceImpl<Requisito>
	...
	@Override
	public Requisito updateImpl(com.rec.hitss.layer.model.Requisito requisito)
		throws SystemException {
		requisito = toUnwrappedModel(requisito);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.Requisito")));
