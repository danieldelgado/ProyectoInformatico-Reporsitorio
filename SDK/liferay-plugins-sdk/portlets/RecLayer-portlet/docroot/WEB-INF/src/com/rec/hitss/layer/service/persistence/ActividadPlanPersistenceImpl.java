...
import com.rec.hitss.layer.NoSuchActividadPlanException;
import com.rec.hitss.layer.model.ActividadPlan;
import com.rec.hitss.layer.model.impl.ActividadPlanImpl;
import com.rec.hitss.layer.model.impl.ActividadPlanModelImpl;
...
public class ActividadPlanPersistenceImpl extends BasePersistenceImpl<ActividadPlan>
	...
	protected ActividadPlan toUnwrappedModel(ActividadPlan actividadPlan) {
		...
		actividadPlanImpl.setDuracion(actividadPlan.getDuracion());
		actividadPlanImpl.setActividad(actividadPlan.getActividad());
		actividadPlanImpl.setCumplio(actividadPlan.isCumplio());
		actividadPlanImpl.setObservacion(actividadPlan.getObservacion());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.ActividadPlan")));
