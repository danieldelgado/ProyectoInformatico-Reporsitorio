...
import com.rec.hitss.layer.NoSuchEvaluacionPreguntaException;
import com.rec.hitss.layer.model.EvaluacionPregunta;
import com.rec.hitss.layer.model.impl.EvaluacionPreguntaImpl;
import com.rec.hitss.layer.model.impl.EvaluacionPreguntaModelImpl;
...
public class EvaluacionPreguntaPersistenceImpl extends BasePersistenceImpl<EvaluacionPregunta>
	 ...
	 */
	@Override
	public EvaluacionPregunta create(long evaluacionPreguntaId) {
		EvaluacionPregunta evaluacionPregunta = new EvaluacionPreguntaImpl();

		evaluacionPregunta.setNew(true);
		evaluacionPregunta.setPrimaryKey(evaluacionPreguntaId);
	 ...
	 */
	@Override
	public EvaluacionPregunta remove(long evaluacionPreguntaId)
		throws NoSuchEvaluacionPreguntaException, SystemException {
		return remove((Serializable)evaluacionPreguntaId);
	}
	...
	protected EvaluacionPregunta toUnwrappedModel(
		...
		evaluacionPreguntaImpl.setEvaluacionPreguntaId(evaluacionPregunta.getEvaluacionPreguntaId());
		...
		evaluacionPreguntaImpl.setDescripcion(evaluacionPregunta.getDescripcion());
	 ...
	 */
	@Override
	public EvaluacionPregunta findByPrimaryKey(long evaluacionPreguntaId)
		throws NoSuchEvaluacionPreguntaException, SystemException {
		return findByPrimaryKey((Serializable)evaluacionPreguntaId);
	}
	 ...
	 */
	@Override
	public EvaluacionPregunta fetchByPrimaryKey(long evaluacionPreguntaId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)evaluacionPreguntaId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.EvaluacionPregunta")));
