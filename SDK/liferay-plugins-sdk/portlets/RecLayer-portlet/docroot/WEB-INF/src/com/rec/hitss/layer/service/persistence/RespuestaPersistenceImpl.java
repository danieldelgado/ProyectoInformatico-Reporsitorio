...
import com.rec.hitss.layer.NoSuchRespuestaException;
import com.rec.hitss.layer.model.Respuesta;
import com.rec.hitss.layer.model.impl.RespuestaImpl;
import com.rec.hitss.layer.model.impl.RespuestaModelImpl;
...
public class RespuestaPersistenceImpl extends BasePersistenceImpl<Respuesta>
	...
	@Override
	public Respuesta updateImpl(com.rec.hitss.layer.model.Respuesta respuesta)
		throws SystemException {
		respuesta = toUnwrappedModel(respuesta);
	...
	protected Respuesta toUnwrappedModel(Respuesta respuesta) {
		...
		respuestaImpl.setPreguntaId(respuesta.getPreguntaId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.Respuesta")));
