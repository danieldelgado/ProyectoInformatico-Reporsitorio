...
import com.rec.hitss.layer.NoSuchInformeRetroalimentacionException;
import com.rec.hitss.layer.model.InformeRetroalimentacion;
import com.rec.hitss.layer.model.impl.InformeRetroalimentacionImpl;
import com.rec.hitss.layer.model.impl.InformeRetroalimentacionModelImpl;
...
public class InformeRetroalimentacionPersistenceImpl extends BasePersistenceImpl<InformeRetroalimentacion>
	...
	protected InformeRetroalimentacion toUnwrappedModel(
		...
		informeRetroalimentacionImpl.setResponsable(informeRetroalimentacion.getResponsable());
		informeRetroalimentacionImpl.setFechaEmision(informeRetroalimentacion.getFechaEmision());
		informeRetroalimentacionImpl.setTitulo(informeRetroalimentacion.getTitulo());
		informeRetroalimentacionImpl.setIntegrante(informeRetroalimentacion.getIntegrante());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.InformeRetroalimentacion")));
