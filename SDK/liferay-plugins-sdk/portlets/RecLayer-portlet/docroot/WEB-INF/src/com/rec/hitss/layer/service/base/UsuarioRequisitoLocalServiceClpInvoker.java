...
public class UsuarioRequisitoLocalServiceClpInvoker {
	public UsuarioRequisitoLocalServiceClpInvoker() {
		...
		_methodParameterTypes1 = new String[] {
				"com.rec.hitss.layer.service.persistence.UsuarioRequisitoPK"
			};
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return UsuarioRequisitoLocalServiceUtil.addUsuarioRequisito((com.rec.hitss.layer.model.UsuarioRequisito)arguments[0]);
		}

		if (_methodName1.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
			return UsuarioRequisitoLocalServiceUtil.createUsuarioRequisito((com.rec.hitss.layer.service.persistence.UsuarioRequisitoPK)arguments[0]);
		}

		if (_methodName2.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
			return UsuarioRequisitoLocalServiceUtil.deleteUsuarioRequisito((com.rec.hitss.layer.service.persistence.UsuarioRequisitoPK)arguments[0]);
		}

		if (_methodName3.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
			return UsuarioRequisitoLocalServiceUtil.deleteUsuarioRequisito((com.rec.hitss.layer.model.UsuarioRequisito)arguments[0]);
		}
		...
		if (_methodName10.equals(name) &&
			...
			return UsuarioRequisitoLocalServiceUtil.fetchUsuarioRequisito((com.rec.hitss.layer.service.persistence.UsuarioRequisitoPK)arguments[0]);
		}

		if (_methodName11.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
			return UsuarioRequisitoLocalServiceUtil.getUsuarioRequisito((com.rec.hitss.layer.service.persistence.UsuarioRequisitoPK)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return UsuarioRequisitoLocalServiceUtil.updateUsuarioRequisito((com.rec.hitss.layer.model.UsuarioRequisito)arguments[0]);
		}
