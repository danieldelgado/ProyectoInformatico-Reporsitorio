...
import com.rec.hitss.layer.model.ActividadPlanModel;
import com.rec.hitss.layer.model.ActividadPlanSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.rec.hitss.layer.model.ActividadPlanModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ActividadPlanImpl}.
 * </p>
 *
 * @author Crossfire
 * @see ActividadPlanImpl
 * @see com.rec.hitss.layer.model.ActividadPlan
 * @see com.rec.hitss.layer.model.ActividadPlanModel
 * @generated
 */
@JSON(strict = true)
public class ActividadPlanModelImpl extends BaseModelImpl<ActividadPlan>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a actividad plan model instance should use the {@link com.rec.hitss.layer.model.ActividadPlan} interface instead.
	 */
	public static final String TABLE_NAME = "ActividadPlan";
	public static final Object[][] TABLE_COLUMNS = {
			{ "actividadPlanId", Types.BIGINT },
			{ "planAccionId", Types.BIGINT },
			{ "duracion", Types.INTEGER },
			{ "actividad", Types.VARCHAR },
			{ "cumplio", Types.BOOLEAN },
	...
	public static final String TABLE_SQL_CREATE = "create table ActividadPlan (actividadPlanId LONG not null primary key,planAccionId LONG,duracion INTEGER,actividad VARCHAR(75) null,cumplio BOOLEAN,observacion VARCHAR(75) null,evidencia VARCHAR(75) null,objetivo VARCHAR(75) null,activo BOOLEAN,usuariocrea LONG,fechacrea DATE null,usuariomodifica LONG,fechacreamodifica DATE null)";
	public static final String TABLE_SQL_DROP = "drop table ActividadPlan";
	public static final String ORDER_BY_JPQL = " ORDER BY actividadPlan.fechacrea ASC";
	public static final String ORDER_BY_SQL = " ORDER BY ActividadPlan.fechacrea ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.rec.hitss.layer.model.ActividadPlan"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.rec.hitss.layer.model.ActividadPlan"),
			true);
	...
	public static ActividadPlan toModel(ActividadPlanSoap soapModel) {
		...
		model.setDuracion(soapModel.getDuracion());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.rec.hitss.layer.model.ActividadPlan"));
	...
	public Object clone() {
		...
		actividadPlanImpl.setDuracion(getDuracion());
		actividadPlanImpl.setActividad(getActividad());
		actividadPlanImpl.setCumplio(getCumplio());
		actividadPlanImpl.setObservacion(getObservacion());
	...
	public CacheModel<ActividadPlan> toCacheModel() {
		...
		actividadPlanCacheModel.duracion = getDuracion();
		...
		actividadPlanCacheModel.cumplio = getCumplio();

		actividadPlanCacheModel.observacion = getObservacion();

		String observacion = actividadPlanCacheModel.observacion;

		if ((observacion != null) && (observacion.length() == 0)) {
			actividadPlanCacheModel.observacion = null;
		}
