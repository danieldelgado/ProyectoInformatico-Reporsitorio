...
import com.rec.hitss.layer.NoSuchSolicitudRequerimientoException;
import com.rec.hitss.layer.model.SolicitudRequerimiento;
import com.rec.hitss.layer.model.impl.SolicitudRequerimientoImpl;
import com.rec.hitss.layer.model.impl.SolicitudRequerimientoModelImpl;
...
public class SolicitudRequerimientoPersistenceImpl extends BasePersistenceImpl<SolicitudRequerimiento>
	...
	protected SolicitudRequerimiento toUnwrappedModel(
		...
		solicitudRequerimientoImpl.setPuestoId(solicitudRequerimiento.getPuestoId());
	 ...
	 */
	@Override
	public List<com.rec.hitss.layer.model.Funcion> getFuncions(long pk)
		throws SystemException {
	...
	public void addFuncions(long pk,
		List<com.rec.hitss.layer.model.Funcion> funcions)
		throws SystemException {
		for (com.rec.hitss.layer.model.Funcion funcion : funcions) {
			solicitudRequerimientoToFuncionTableMapper.addTableMapping(pk,
				funcion.getPrimaryKey());
		}
	}
	...
	public void setFuncions(long pk,
		...
		try {
			...
			for (int i = 0; i < funcions.size(); i++) {
				com.rec.hitss.layer.model.Funcion funcion = funcions.get(i);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rec.hitss.layer.model.SolicitudRequerimiento")));
	...
	protected TableMapper<SolicitudRequerimiento, com.rec.hitss.layer.model.Funcion> solicitudRequerimientoToFuncionTableMapper;
